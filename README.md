...
| **Block/storage** | parted, gdisk, fdisk, lvm2, mdadm, cryptsetup, device-mapper-multipath, iscsi-initiator-utils, nvme-cli, sg3_utils, lsscsi, sdparm, hdparm, smartmontools, blktrace, fio, ioping, nbd, ubdsrv (ublk) |
| **io_uring** | liburing, liburing-devel, ubdsrv (ublk — userspace block driver via io_uring) |
